...
public class ProjectListController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<form action='SearchController' method='get'>");
		
		pw.print(" <div class='search'>\r\n" + 
				"        <input class='search-input' type='search' placeholder='search by project name' width='600px'>\r\n" + 
				"    <button>serch </button></div>");
		//pw.print("<button>serch </button>");
		pw.print("</form><br><br>");
